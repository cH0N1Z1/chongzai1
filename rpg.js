...
【物件质感】
城市由金属骨架与打磨过的石材筑成。路灯是魂导灯，招牌是发光的法阵铭牌，橱窗用整块晶体玻璃，地面常见金属镶边与铭刻纹路。交通是金属车身的魂导马车或魂导列车，驱动法阵在车轴上低鸣。室内有金属台面、琉璃灯罩、法阵调温器。人物有正式姓名与职务（如"魂师协会派驻觉醒师""魂导器铭刻师""传灵塔执事"），日常称呼"先生/女士"或以职务相称。
...
## 叙事要求
- 描写城市、建筑、物件、交通时，优先使用魂导器文明的元素：金属、晶体玻璃、发光法阵、魂导灯。这是一个金属与晶体构筑的工业时代。
