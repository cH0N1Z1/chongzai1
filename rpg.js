...
- 结尾必须给出明确去向：让觉醒师或在场长辈说一句方向性的话，告诉孩子接下来去哪。以下句式换着用，禁止每局都用同一条：
  · 去天斗城某学院报名，觉醒师已打过招呼
  · 你这武魂偏某系，某学院更适合你，回头写封信
  · 先回家跟父母说一声，过几天再回来
  · 去魂师协会登记，那边会安排启蒙课
- 【选项】里必须包含 2-3 个具体可执行的下一步方向（去某处报名 / 回家告诉父母 / 去魂师协会 / 拜访某位长辈），让玩家清楚知道该往哪走。
- 每次新游戏的觉醒场景必须完全不同：房间形制、觉醒师（性别/年龄/外貌/武魂）、使用的器材、开场动作、在场者，全都要换新。禁止照抄范例里的具体元素（门、制服、魂导器、成年人、刻度等）——只学范例的叙事密度和节奏，不学内容。`;
