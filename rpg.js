...
//  游戏核心数据
// ============================================================
const FIXED_WORLD=`斗罗大陆 · 绝世唐门时代（一万年后）。这是魂导器工业文明，不是古代王朝。
城市：柏油路、魂导灯、多层公寓、魂导列车/汽车/飞艇、机械装置、金属玻璃质建筑、制服、检票员、巡捕。
乡村：朴素但有魂导灯和铁器，不是农耕古代。
交通枢纽叫"车站/中转站"，学校叫"学院/学府"，旅馆不叫客栈，城卫军不叫衙门衙役。
禁用古词：马车、轿子、驿站、客栈、书院、私塾、县令、衙门、蜡烛、油灯、长衫、儒袍、折扇、石阶、阁楼、门槛、柴门、铜钱、两、喂鸡、挑水、砍柴。
...
## 叙事范例（模仿密度、节奏与用语）
觉醒室的金属门无声滑开，一位穿深蓝魂师制服的中年男人走进来，掌心的魂导水晶泛着微光。
"放松，孩子。"他把水晶贴近你的额头，"别怕，就像被灯照了一下。"
你闭上眼睛，感觉到一股暖流顺着经脉游走，*在胸口汇聚成一个光点*。
"呵——"男人眼神一亮，水晶上的刻度纹亮了一格，"有意思。"
...
- 结尾必须给出明确去向：让觉醒师或在场长辈说一句方向性的话（如"后天坐魂导列车去天斗城，启明馆三月招生""你这武魂适合青岚学院，我给你写张推荐信""先回家跟父母说一声，让他们准备行李"）。六岁孩子的人生在此分岔，绝不能觉醒完就散场。
